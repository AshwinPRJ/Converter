...
<script type="text/javascript">
	function showGeneratedReport(){
		...
		window.open("RptCustomerWalletReport.jsp?&txtFromDate="+fromdate+"&txtToDate="+todate,'MyPopup','resizable=yes,width=1000,height=570,scrollbars=yes,left=0,top=0');
	}
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="addAmt">
								<form class="form-horizontal" name="CustWalletReport" id="CustWalletReport">
									<fieldset>
										<h3 align="center">Shoppy Wallet Report</h3>
										<!-- <label class="control-label" for="addCustId">Customer Id</label><input class="form-control input-sm chat-input" type="text" id="addCustId" name="addCustId" placeholder="Please Enter Id" onblur="fnCustValidation()"/>
										<br>
										<label class="control-label">Customer Name</label><input class="form-control input-sm chat-input" type="text" id="addCustName" name="addCustName" readonly="readonly"/> -->
										<br>
										<table align="center">
											<tr>
										...
										<input class="form-control input-sm chat-input" type="hidden" id="addAmount" name="addAmount"/>
										<input type="hidden" id="addCustBalWalAmount" name="addCustBalWalAmount"/>
										<br>
										<div class="wrapper" align="center">
											<input type="button" class="btn btn-success" id="btnShowReport"	value="Show Report" onclick="showGeneratedReport()"/>
											<input type="reset" class="btn btn-danger" value="Clear"/>
											<input type="reset" class="btn btn-link" id="" value="Go Back" onclick="window.location.href='../views/CustomerCreation.jsp'" />
										</div>
									</fieldset>
								</form>
							</div>
