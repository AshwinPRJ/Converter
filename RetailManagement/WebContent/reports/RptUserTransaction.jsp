...
<script type="text/javascript">
	function showGeneratedUserReport(){
		...
		window.open("RptUserTransactionReport.jsp?&txtFromDate="+fromdate+"&txtToDate="+todate,'','resizable=yes,width=1000,height=570,scrollbars=yes,left=0,top=0');
	}
	/* calender function*/
	function y2k(number) {
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="addAmt">
								<form class="form-horizontal" name="CustWalletReport" id="CustWalletReport">
									<fieldset>
										<h3 align="center">User Transaction Report</h3>
										<br>
										<table align="center">
											<tr>
