...
<title>Shoppy Wallet Transactions</title>
...
<script type="text/javascript">
	function showGeneratedReport(){
		...
		window.open("RptCustomerWalletTransactionReport.jsp?&txtFromDate="+fromdate+"&txtToDate="+todate,'MyPopup','resizable=yes,width=1000,height=570,scrollbars=yes,left=0,top=0');
	}
	/* calender function*/
	function y2k(number) {
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="addAmt">
								<form class="form-horizontal" name="CustWalletReport" id="CustWalletReport">
									<fieldset>
										<h3 align="center">Shoppy Report</h3>
										<br>
										<table align="center">
											<tr>
										...
										<div class="wrapper" align="center">
											...
											<input type="reset" class="btn btn-link" id="" value="Go Back" onclick="window.location.href='../views/UserPoints.jsp'" />
										</div>
									</fieldset>
								</form>
							</div>
