				...
				<div class="col-md-offset-4 col-md-3 col-sm-12">
					...
					<div class="well">
						<div>
							...
							<br>
							<label>Admin Id</label> <input class="form-control input-sm chat-input" type="text" id="txtAdminId" name="txtAdminId" maxlength="20" placeholder="Please Enter Admin Id" onblur="fnAdminCheck()" />
							<br> <label>Password</label> <input	class="form-control input-sm chat-input" type="password" id="adminPswd" name="adminPswd" maxlength="20" placeholder="Please Enter the Password" />
							<br>
							<div class="wrapper" align="center">
								<input type="button" class="btn btn-success" id="btnAdminLogin" value="Login" onclick="fnAdminLoginOnClick()" />
