...
public final class Utils {
	 ...
	 * @return
	 */
	public static int getDifferenceBwnTimeInMins(Timestamp timeA, Timestamp timeB) {
	 ...
	 * @return
	 */
	public static int getDifferenceBwnTimestampsInDays(Timestamp timeA, Timestamp timeB) {
		long diff = timeA.getTime() - timeB.getTime();
	...
	public static UserCreationBean getCurrentUser(HttpServletRequest httpServletRequest) {
		return (UserCreationBean) httpServletRequest.getSession().getAttribute(VyavaharaConstants.USER);
	}
}